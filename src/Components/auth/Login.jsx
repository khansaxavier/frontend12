                            ...
                            <form className="space-y-4 md:space-y-6" onSubmit={submitHandler}>
                                <div>
                                    ...
                                    <input type="text" name="email" id="email" value={username}
                                        ...
                                        dark:focus:border-blue-500" placeholder="user123" required 
                                ...
                                <button type="submit" className="w-full text-white bg-blue-500 hover:bg-primary-700 focus:ring-4 
                                ...
                                <p className="text-sm font-light text-gray-500 dark:text-gray-400">
                                    Don’t have an account yet? <Link to="/register" className="font-medium 
                                    text-primary-600 hover:underline dark:text-primary-500">Register</Link>
                                </p>
                            </form>
                        </div>
                    </div>
